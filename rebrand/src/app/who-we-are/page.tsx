...
export default function WhoWeArePage() {
  ...
  return (
    <div className="min-h-screen flex overflow-hidden flex-col bg-white">
      ...
      {/* Section 1: Hero */}
      <section className="relative w-full min-h-[580px] flex items-left justify-center text-white text-center px-6 pt-50">
        <Image
        ...
        <div className="relative z-20 max-w-4xl">
          <h1 className="text-4xl font-bold mb-4">
            The Best Hands needed for your project success
          </h1>
      ...
      <section className="w-full py-12 bg-white">
        ...
        <p className="text-gray-900 pl-10 pr-10 font-semibold text-left max-w-auto w-full md:w-full lg:w-full mb-2">
          At Digisperts, we are more than just a technology company; we are your
          dedicated partners in digital transformation. We empower businesses,
          from agile startups to large enterprises, to not just meet, but
          consistently exceed their goals. Our foundation is built on a
          commitment to transformative innovation, unwavering partnership, and
          bridging global talent with cutting-edge technology to deliver bespoke
      ...
      <div className="relative w-full flex flex-col lg:pl-10 lg:pr-10 pb-0 lg:pb-8">
        ...
        <div className="flex w-full flex-col lg:flex-row justify-center items-end gap-4 lg:gap-88 lg:mt-0">
          ...
          <div className="relative w-full lg:w-[320px] lg:h-[340px] flex items-center justify-center mb-2 lg:mb-0">
            <div className="w-full bg-[#F8C6C6] rounded-lg shadow-lg p-6 lg:absolute z-30 lg:top-1/2 lg:left-0 lg:-translate-y-1/2">
              <h3 className="text-3xl font-bold text-[#3B1F1F] mb-2 text-center">
                The mission
              </h3>
          ...
          <div className="relative w-full lg:w-[320px] lg:h-[340px] flex items-center justify-center mt-2 lg:mt-0">
            <div className="w-full bg-[#FFE6A7] rounded-lg shadow-lg p-6 lg:absolute lg:top-1/2 lg:left-0 lg:-translate-y-1/2">
              <h3 className="text-3xl font-bold text-[#7A5A00] mb-2 text-center">
                The vision
              </h3>
              <p className="text-sm text-[#222] text-left">
                {visionShort}
      ...
      <section className="relative w-full flex justify-center items-center py-0 lg:-mt-20">
        ...
        <div className="relative w-full lg:w-[800px] h-[370px] flex items-center mr-4 lg:mr-0 justify-center">
          {/* Bottom Card */}
          <div
            className={`absolute left-1/2 top-[50px] -translate-x-1/2 w-full lg:${
              showFullApproach ? "w-[600px]" : "w-[320px]"
            } bg-[#A7B6F8] rounded-lg lg:mt-16 shadow-lg p-6 mx-2 lg:mx-0 transition-all duration-500`}
          >
            <h3 className="text-3xl font-bold text-[#1A2257] mb-2 text-center">
              Our Approach
            </h3>
            <p className="text-sm text-[#222] text-left">
              {approachShort}
      ...
      {/* Our Team Section */}
      <ScrollFadeSection>
        <section className="w-full pt-10 py-2 bg-white">
          <h2 className="mb-7 pl-10 text-left">
            <span className="block text-2xl sm:text-3xl md:text-3xl lg:text-3xl font-extrabold bg-gradient-to-b from-black to-blue-900 bg-clip-text text-transparent">
          ...
          <p className="text-gray-900 pl-10 pr-10 font-semibold text-left max-w-auto w-full md:w-full lg:w-full mb-12">
            At Digisperts, our strength lies in our people. We are a collective
            of trusted experts and dedicated professionals, passionate about
            technology and committed to your success. Each member of our team
            brings a wealth of experience, a collaborative spirit, and a drive
            for continuous learning, ensuring we deliver innovative and tailored
        ...
        <section className="w-full py-8 bg-white">
          <div className="max-w-6xl mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8 px-4">
            ...
            <div className="flex flex-col items-center sm:items-start">
              ...
              />
              <span className="font-extrabold text-sm text-[#1E429F] text-left">
                Harvey, A
              </span>
          ...
          >
            <div className="w-full lg:max-w-4xl text-white lg:ml-8 mt-1 rounded-lg">
              <ScrollFadeSection>
                ...
                <div className="text-sm lg:text-base font-medium text-black mb-5">
