...
export default function BlockchainExploreOurWork() {
    return (
      <ExploreLayout
        heroTitle=" Blockchain info goes here!!!"
        ...
        outcomeData={{
          ...
          outcomes: [
            {
              icon: <Image src="/images/explore-our-work/blockchain/outcome1.png" alt="" width={40} height={40} />,
              title: "6-Month Faster",
              text: "Time-to-market compared to the projected in-house development timeline.",
              bgColor: "#D3E1FF"
            },
            {
              icon: <Image src="/images/explore-our-work/blockchain/outcome2.png" alt="" width={40} height={40} />,
              title: "40% Reduction",
              text: "In customer support calls related to product operation and usability.",
              bgColor: "#FFD0D0"
            },
            {
              icon: <Image src="/images/explore-our-work/blockchain/outcome3.png" alt="" width={40} height={40} />,
        ...
        technologiesData={{
          ...
          technologies: [
            { icon: <Image src="/images/explore-our-work/blockchain/cplus.png" alt="C++/Qt" width={64} height={64} />, name: "C++/Qt" },
            { icon: <Image src="/images/explore-our-work/blockchain/linux.png" alt="Embedded Linux/Yocto" width={64} height={64} />, name: "Embedded Linux/Yocto" },
            { icon: <Image src="/images/explore-our-work/blockchain/mqtt.png" alt="MQTT" width={64} height={64} />, name: "MQTT" },
            { icon: <Image src="/images/explore-our-work/blockchain/python.png" alt="Python" width={64} height={64} />, name: "Python" },
            { icon: <Image src="/images/explore-our-work/blockchain/modbus.png" alt="Modbus" width={64} height={64} />, name: "Modbus" },
          ]
        }}
        preFooterData={{
