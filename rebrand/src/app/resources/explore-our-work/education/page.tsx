...
export default function EducationExploreOurWork() {
  return (
    <ExploreLayout
      heroTitle=" Education info goes here!!!"
      ...
      heroImage="/images/explore-our-work/blockchain/blockchain-hero.png"
      challengeData={{
        title: "The Challenge",
        description:
          "A manufacturer of innovative industrial hardware lacked the specialized software development expertise to create a user interface that matched the quality of their physical product.",
        challenges: [
          {
            title: "Lack of In-House Software Talent",
            text: (
              <>
                The company&apos;s core competency was <br />
                hardware engineering, not software <br />
                UI/UX design or application <br />
                development.
              </>
            ),
            imageSrc: "/images/explore-our-work/blockchain/pin.png",
          },
          {
            title: "Risk of Poor User Experience",
            text: (
              <>
                A clunky or unreliable software <br />
          ...
          },
          {
            ...
            text: (
              <>
                Attempting to build the software in-
                <br />
        ...
        steps: [
          {
            ...
            description:
              "We held intensive workshops with the hardware team to define requirements and created interactive prototypes for early feedback.",
            color: "#AFC6F7",
            numberColor: "#001133",
            number: "1",
          },
          {
            ...
            description:
              "We developed the software in two-week sprints, with regular demos to ensure the project stayed aligned with the client's vision.",
            color: "#F5AFAF",
            numberColor: "#3D0000",
            number: "2",
          },
          {
            ...
            description:
              "We performed rigorous testing with the actual hardware to validate performance and reliability under real-world conditions.",
            color: "#FFE6B5",
            numberColor: "#664503",
            number: "3",
          },
          {
            ...
            description:
              " We delivered the fully branded, production-ready software package with comprehensive documentation for a seamless handover.",
            color: "#9BB5EB",
            numberColor: "#00143D",
            number: "4",
          },
      ...
      solutionData={{
        ...
        description:
          "Digisperts acted as the dedicated OEM software development partner, delivering a production-ready, white-labeled application.",
        solutions: [
          {
      ...
      chatbotData={{
        image: "/images/explore-our-work/blockchain/chatbot.png",
        alt: "Chatbot UI",
      }}
      outcomeData={{
        title: "The Outcome",
        description:
          "The custom software became a key differentiator for the hardware, accelerating sales and enhancing the brand's reputation for quality and innovation.",
        outcomes: [
          {
            icon: (
              <Image
                src="/images/explore-our-work/blockchain/outcome1.png"
                alt=""
                width={40}
                height={40}
              />
          ...
          },
          {
            icon: (
              <Image
                src="/images/explore-our-work/blockchain/outcome2.png"
                alt=""
                width={40}
                height={40}
              />
          ...
          },
          {
            icon: (
              <Image
                src="/images/explore-our-work/blockchain/outcome3.png"
                alt=""
                width={40}
                height={40}
              />
        ...
        technologies: [
          {
            icon: (
              <Image
                src="/images/explore-our-work/blockchain/cplus.png"
                alt="C++/Qt"
                width={64}
                height={64}
              />
          ...
          },
          {
            icon: (
              <Image
                src="/images/explore-our-work/blockchain/linux.png"
                alt="Embedded Linux/Yocto"
                width={64}
                height={64}
              />
            ),
            name: "Embedded Linux/Yocto",
          },
          {
            icon: (
              <Image
                src="/images/explore-our-work/blockchain/mqtt.png"
                alt="MQTT"
                width={64}
                height={64}
              />
          ...
          },
          {
            icon: (
              <Image
                src="/images/explore-our-work/blockchain/python.png"
                alt="Python"
                width={64}
                height={64}
              />
          ...
          },
          {
            icon: (
              <Image
                src="/images/explore-our-work/blockchain/modbus.png"
                alt="Modbus"
                width={64}
                height={64}
              />
      ...
      preFooterData={{
        ...
        subheading:
          "Focus on what you do best. Let us build the software that makes your hardware shine.",
