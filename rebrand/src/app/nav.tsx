...
const NavBar = () => {
  ...
  const navLinkClass =
    "group relative font-medium text-gray-700 hover:text-blue-900 px-3 md:px-2 py-2 rounded transition-opacity duration-700 ease-out whitespace-nowrap custom-nav-text";
  const buttonClass =
    "bg-blue-900 text-white px-4 md:px-2 py-2 rounded transition-opacity duration-700 ease-out border border-transparent hover:bg-white hover:text-blue-900 hover:border-blue-900 whitespace-nowrap custom-nav-text";
  ...
  return (
    <header className="flex items-center justify-between px-8 py-4 border-b bg-white relative z-20 font-poppins">
      ...
      <nav className="hidden lg:flex items-center space-x-6 custom-nav-text">
        ...
        >
          <button
            ...
            className={`${navLinkClass} ${
              whatWeDoOpen ? "bg-blue-100 text-blue-900 font-semibold" : ""
        ...
        <Link
          href="/who-we-are"
          className={`${navLinkClass} transition-opacity ${getOpacityClass(2)} ${
            pathname === "/who-we-are"
              ? "bg-blue-100 text-blue-900 font-semibold"
              : "text-black hover:bg-blue-50 hover:text-blue-900 active:bg-blue-100 active:text-blue-900"
          }`}
        ...
        <Link
          href="/process"
          className={`${navLinkClass} transition-opacity ${getOpacityClass(3)} ${
            pathname === "/process"
              ? "bg-blue-100 text-blue-900 font-semibold"
              : "text-black hover:bg-blue-50 hover:text-blue-900 active:bg-blue-100 active:text-blue-900"
          }`}
        ...
        <Link
          ...
          className={`${buttonClass} ${getOpacityClass(5)} flex font-semibold items-center transition duration-300 ease-out transform-gpu hover:rotate-[2deg] hover:origin-top-right hover:scale-[1.02] hover:shadow-md`}
        >
