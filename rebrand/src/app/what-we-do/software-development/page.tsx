      ...
      <div className="min-h-screen flex overflow-hidden flex-col bg-white">
        ...
        <section className="py-16 px-6 text-left" id="approach">
          ...
          <p className="text-[#3C3C3C] font-semibold text-left max-w-auto w-full md:w-full lg:w-full mb-12">
            ...
            To truly exceed your goals, you need technology solutions built
            specifically for you. At Digisperts, we move beyond the limitations
            of outdated technology stacks to deliver robust, custom software. As
            your unwavering partner, we dive deep into your vision to build
            applications that not only solve today&apos;s problems but also
          ...
          <div className="grid md:grid-cols-2 gap-8 items-center">
            ...
            <div className="space-y-6 text-left">
              ...
              <p className="text-black font-semibold text-sm  text-left max-w-2xl mx-auto mb-1 font-19px">
                Our process is built on a foundation of partnership and a
                commitment to <br /> quality excellence.
              </p>
              ...
              <div className="bg-gray-100 p-6 shadow-md rounded-md flex flex-row items-center gap-3">
                ...
                <div className="flex flex-col text-left">
                  ...
                  <p className="text-sm text-[#000000]">
                    We begin by listening. Our client-centric approach means we
                    work closely with you to understand your goals, workflows,
                    and challenges, ensuring the final product is a perfect fit.
                  </p>
                </div>
              </div>
              ...
              <div className="bg-gray-100 p-6 shadow-md rounded-md flex w-full md:w-full lg:w-[80%] sm:w-full flex-row items-center gap-3">
                ...
                <div className="flex flex-col text-left">
                  ...
                  <p className="text-sm text-[#000000]">
                    We leverage cutting-edge technologies and an agile <br />{" "}
                    development process. This allows us to remain <br />{" "}
                    adaptable , incorporate feedback, and deliver <br />{" "}
              ...
              <div className="bg-gray-100 p-6 shadow-md rounded-md flex w-full md:w-full lg:w-[60%] sm:w-full flex-row items-center gap-3">
                ...
                <div className="flex flex-col text-left">
                  ...
                  <p className="text-sm text-[#000000]">
                    We bake in enterprise-grade security and build for
                    scalability from day one, empowering your business with a
                    secure and future-proof technological foundation.
                  </p>
                </div>
              </div>
            </div>
        ...
        <section id="services" className="py-14 px-2 md:px-8">
          <div className="border-2 border-dashed border-[#D9D9D9] rounded-[8px] bg-white px-4 md:px-10 py-8">
            ...
            <p className="text-left text-[#3C3C3C] font-semibold mb-8">
              We provide end-to-end development to bring your vision to life.
            </p>
            ...
            <div className="flex flex-col-reverse md:flex-row gap-6 md:gap-8 items-stretch mb-8 bg-[#F8F8F8] p-4 rounded">
              <div className="flex-1 flex flex-col justify-center items-start">
                ...
                <p className="text-gray-900 mb-4">
                  We build powerful, secure web apps with robust back-ends and
                  intuitive, visually appealing user interfaces. From enterprise
                  dashboards to customer portals, our solutions are designed to
              ...
              <div className="md:relative flex flex-1 md:flex-row flex-col-reverse items-center gap-4 bg-[#F8F8F8] p-4 rounded">
                <div className="flex-1 flex flex-col justify-center items-start">
                  ...
                  <p className="md:w-120 text-gray-900">
                    We help you successfully design, build, and launch mobile
                    apps for iOS and Android. We balance performance with
                    possibility, creating scalable solutions that grow with you
              ...
              <div className="md:items-start md:flex-col flex flex-col items-center gap-4 bg-[#F8F8F8] p-4 rounded">
                ...
                <div className="flex flex-col justify-center items-start w-full">
                  ...
                  <p className="text-gray-900">
                    We develop specialized software tailored for unique business
                    environments, including custom integrations and OEM
                    software. Our focus is on creating reliable,
                    high-performance tools that enhance your core business
                    functions.
                  </p>
                  <Link
                    href="/schedule-a-consultation"
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <div className="bg-white shadow-lg flex flex-col items-start w-full max-w-[370px] min-w-[280px] mx-auto">
              ...
              <div className="px-6 pt-6 pb-7 w-full">
                ...
                <p className="text-[#3C3C3C] text-base font-semibold text-sm mb-4 leading-snug">
                  Engineering a Secure Token Ecosystem on Binance Smart Chain
                  for a Financial Services Innovator.
                </p>
                <Link
            ...
            <div className="bg-white shadow-lg flex flex-col items-start w-full max-w-[370px] min-w-[280px] mx-auto">
              ...
              <div className="px-6 pt-6 pb-7 w-full">
                ...
                <p className="text-[#3C3C3C] text-base font-semibold text-sm mb-4 leading-snug">
                  Developing a Scalable Learning Management System (LMS) to
                  Power a Global Online Academy.
                </p>
                <Link
            ...
            <div className="bg-white shadow-lg flex flex-col items-start w-full max-w-[370px] min-w-[280px] mx-auto">
              ...
              <div className="px-6 pt-6 pb-7 w-full">
                ...
                <p className="text-[#3C3C3C] text-base font-semibold text-sm mb-4 leading-snug">
                  Building Custom Agri-Tech Software to Streamline Operations
                  for a Leading Agricultural Processing Company.
                </p>
                <Link
