      ...
      <div className="min-h-screen flex overflow-hidden flex-col bg-white">
        ...
        <section className="py-16 px-6 text-left">
          ...
          <p className="text-gray-600 font-semibold text-left max-w-auto w-full md:w-full lg:w-full mb-12">
            Are manual processes and repetitive tasks slowing your business
            down? helps you reclaim that power. As your trusted digital
            transformation partner, we specialize in creating tailored
            automation solutions that address your specific inefficiencies. We
            go beyond simple fixes to build systems that unlock your team&apos;s
            true potential and drive measurable success.
          </p>
            ...
            <div className="space-y-6 text-left">
              ...
              <div className="bg-gray-100 p-6 shadow-md rounded-md flex flex-row items-center gap-3">
                ...
                <div className="flex flex-col text-left">
                  ...
                  <p className="text-sm text-[#000000]">
                    We begin by thoroughly analyzing your existing workflows to
                    identify the key areas where automation can deliver the most
                    significant impact on cost, time, and accuracy.
                  </p>
                </div>
              </div>
              {/* Design & Implement */}
              <div className="bg-gray-100 p-6 shadow-md rounded-md flex w-full md:w-full lg:w-[80%] sm:w-full flex-row items-center gap-3">
                ...
                <div className="flex flex-col text-left">
                  ...
                  <p className="text-sm text-[#000000]">
                    We leverage innovative, cutting-edge technology to design
                    and implement custom automation solutions, from intelligent
                    chatbots to financial controls, that integrate seamlessly
              ...
              <div className="bg-gray-100 p-6 shadow-md rounded-md flex w-full md:w-full lg:w-[60%] sm:w-full flex-row items-center gap-3">
                ...
                <div className="flex flex-col text-left">
                  ...
                  <p className="text-sm text-[#000000]">
                    Our goal is to empower your business. We ensure your team is
                    equipped to use the new tools effectively and we
                    continuously monitor performance to optimize for peak
                    efficiency.
                  </p>
                </div>
              </div>
        ...
        <section className="py-14 px-2 md:px-8">
          <div className="border-2 border-dashed border-[#D9D9D9] rounded-[8px] bg-white px-4 md:px-10 py-8">
            ...
            <p className="text-left text-gray-900 mb-8">
              We create tailored solutions to address your most pressing
            ...
            <div className="flex flex-col md:flex-row gap-8 mb-8">
              ...
              <div className="md:w-7/12 flex flex-col md:flex-row bg-white p-6 shadow-lg rounded-md">
                ...
                <div className="md:w-7/12">
                  ...
                  <p className="text-gray-900">
                    We build and train custom AI models to power intelligent
                    systems. This includes AI-enhanced chatbots that learn your
                    business to provide instant, human-like customer support. We
                    also develop smart internal knowledge bases, training them
                    on your organization&apos;s Standard Operating Procedures
                    (SOPs) to empower your team with immediate and accurate
                    information.
                  </p>
                  <Link
                    href="/schedule-a-consultation"
              ...
              <div className="md:w-6/14 bg-white p-6 shadow-lg rounded-md flex flex-col justify-between">
                <div>
                  ...
                  <p className="text-gray-900">
                    Enhance accuracy and gain control over your finances. We
                    automate invoicing, data entry, and reporting to reduce
                    errors, ensure compliance, and provide you with real-time
                    financial insights.
                  </p>
                  <Link
                    href="/schedule-a-consultation"
            ...
            <div className="flex flex-col md:flex-row gap-8">
              ...
              <div className="md:w-6/14 bg-white p-6 shadow-lg rounded-md flex flex-col justify-between">
                <div>
                  ...
                  <p className="text-gray-900">
                    Connect disparate systems and automate the flow of data
                    across your organization. We reduce manual data handling to
                    improve efficiency, minimize errors, and provide a unified
              ...
              <div className="md:w-7/12 flex flex-col md:flex-row bg-white p-6 shadow-lg rounded-md">
                ...
                <div className="md:w-7/12">
                  ...
                  <p className="text-gray-900">
                    Build stronger, more lasting customer relationships by
                    automating communication, tracking interactions, and
                    personalizing the customer journey, improving retention and
                    satisfaction.
                  </p>
                  <Link
                    href="/schedule-a-consultation"
        ...
        <section className="py-20 px-6 md:px-20">
          ...
          <div className="grid md:grid-cols-3 gap-6">
                  <div className="bg-white shadow-lg flex flex-col items-start w-full max-w-[370px] min-w-[280px] mx-auto">
                    ...
                    <div className="px-6 pt-6 pb-7 w-full">
                      ...
                      <p className="text-[#3C3C3C] text-base font-semibold text-sm mb-4 leading-snug">
                        Automating High-Quality Lead Capture and Nurturing to Drive Growth for a Consulting Firm.
                      </p>
                      <Link
                  ...
                  <div className="bg-white shadow-lg flex flex-col items-start w-full max-w-[370px] min-w-[280px] mx-auto">
                    <div className="px-6 pt-0 pl-0 pr-0 w-full">
                      <Image
                        src="/images/reuseable-realestate.jpg"
                        alt="real-estate"
                        width={400}
                        height={250}
                        className="w-full h-[250px] object-cover"
          ...
          <div className="relative w-full h-64 flex items-center justify-center mb-8">
            ...
            <div className="absolute inset-0 flex flex-col items-center justify-center z-20 px-4 py-6 md:py-10">
              ...
              <p className="max-w-auto mx-auto text-center text-white text-sm md:text-lg font-normal">
                Our automation solutions have a proven track record of helping
                our clients achieve remarkable results, including significant
                increases in productivity, higher customer retention, and
                substantial cost savings in administrative overhead.
              </p>
            </div>
          </div>
        </section>
                ...
                {[1, 2].map((repeat) => (
                  ...
                  >
                    <div className="flex flex-row items-center gap-2">
                      <Image
                        src="/images/what-we-do/business-auto/microsoft.png"
                        alt="Microsoft"
                        width={80}
                        height={80}
                    ...
                    <div className="flex flex-row items-center gap-2">
                      <Image
                        src="/images/what-we-do/business-auto/zapier.png"
                        alt="Zapier"
                        width={80}
                        height={80}
                        className="object-contain"
                    ...
                    <div className="flex flex-row items-center gap-2">
                      <Image
                        src="/images/what-we-do/business-auto/uipath.png"
                        alt="UiPath"
                        width={80}
                        height={80}
                        className="object-contain"
                    ...
                    <div className="flex flex-row items-center gap-2">
                      <Image
                        src="/images/what-we-do/business-auto/salesforce.png"
                        alt="Salesforce"
                        width={80}
                        height={80}
                        className="object-contain"
              ...
              >
                <div className="p-6 md:p-27 max-w-full md:max-w-4xl text-white ml-8 mt-1 rounded-lg">
                  ...
                  <div className="text-sm md:text-base font-normal mb-5">
                    Stop losing time to repetitive tasks. Let&apos;s build a
                    more efficient, productive, and powerful future for your
                    business.
                  </div>
